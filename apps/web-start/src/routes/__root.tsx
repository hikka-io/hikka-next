    ...
    head: () => ({
        meta: [
            ...
            { name: 'color-scheme', content: 'dark light' },
            {
                name: 'keywords',
                content:
                    'аніме,аніме українською,мультфільми українською,дивитись аніме,аніме для дорослих,anime,аніме романтика,аніме комедія,аніме школа,хіка,хікка,hikka,hikka.io,хіка іо,енциклопедія аніме,енциклопедія манги,енциклопедія ранобе,аніме жанри,онлайн на українській,жанри аніме,anime ukr,анітюб,Найкраще аніме,аніме портал,Аніме Портал,аніме культура,манга,манґа,ранобе',
            },
        ],
        links: [
