...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                '-mx-4 -mt-4 grid gap-1.5 border-b surface-inset p-4 pt-6 text-center group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center sm:text-left',
                className,
            )}
            {...props}
        />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                '-mx-4 -mb-4 flex flex-col gap-2 border-t surface-inset p-4',
                className,
            )}
            {...props}
        />
