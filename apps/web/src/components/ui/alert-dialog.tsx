...
function AlertDialogFooter({
    ...
    return (
        <div
            ...
            className={cn(
                '-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl p-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 md:flex-row md:justify-end',
                className,
            )}
            {...props}
        />
