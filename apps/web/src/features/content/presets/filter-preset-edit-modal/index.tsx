...
import { FormAgeRating } from '@/components/filters/age-rating';
import { FormDateRange } from '@/components/filters/date-range';
import { FormGenre } from '@/components/filters/genre';
import { FormLocalization } from '@/components/filters/localization';
import { FormMediaType } from '@/components/filters/media-type';
import { FormReleaseStatus } from '@/components/filters/release-status';
import { FormScore } from '@/components/filters/score';
import { FormSeason } from '@/components/filters/season';
import { FormSort, SortType } from '@/components/filters/sort';
import { FormStudio } from '@/components/filters/studio';
import { FormYear } from '@/components/filters/year';
