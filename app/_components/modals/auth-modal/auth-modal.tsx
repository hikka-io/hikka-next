...
import ForgotPasswordForm from '@/app/_components/modals/auth-modal/_components/forgot-password-form';
import LoginForm from '@/app/_components/modals/auth-modal/_components/login-form';
import PasswordConfirmForm from '@/app/_components/modals/auth-modal/_components/password-confirm-form';
import SignUpForm from '@/app/_components/modals/auth-modal/_components/signup-form';
import getOAuth from '@/app/_utils/api/auth/getOAuth';
