...
import CustomizationForm from '@/app/_components/modals/user-settings-modal/_components/customization-form';
import EmailForm from '@/app/_components/modals/user-settings-modal/_components/email-form';
import GeneralForm from '@/app/_components/modals/user-settings-modal/_components/general-form';
import PasswordForm from '@/app/_components/modals/user-settings-modal/_components/password-form';
import UsernameForm from '@/app/_components/modals/user-settings-modal/_components/username-form';
import WatchListForm from '@/app/_components/modals/user-settings-modal/_components/watchlist-form';
