...
const RadialProgress = ({ progress }: { progress: number }) => (
    <div tw="flex relative w-32 h-32" role="progressbar">
        <div tw="flex w-full h-full absolute z-10 top-0 left-0 items-center justify-center">
            <p>497</p>
        </div>
        <svg
            style={{
        ...
        >
            ...
            <circle
                ...
                r="40"
                fill="transparent"
                strokeDasharray="192.16880601035413, 59.15860627682932"
                style={{
                    color: 'rgba(54,123,53,0.5)',
                    stroke: 'currentColor',
                    strokeDasharray: '192.169, 59.159',
                }}
            ></circle>
        </svg>
    </div>
...
export async function GET(
    ...
    const stats = ['completed', 'watching', 'planned'];

    const filteredStats = Object.keys(watchStats).filter(
        (stat) => stat in WATCH_STATUS && stats.includes(stat),
    );
                    ...
                    <div tw="flex w-full">
                        ...
                        >
                            <div tw="flex flex-col w-full" style={{ gap: 16 }}>
                                ...
                                <h2 tw="m-0 text-zinc-400 text-left">
                                    {user.description}
                                </h2>
                            </div>
