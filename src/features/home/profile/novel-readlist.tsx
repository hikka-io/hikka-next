...
const NovelReadlist: React.FC<NovelReadlistProps> = () => {
    ...
    // Rendering Helper: Novel Details
                        ...
                        <Label className="cursor-pointer text-xs text-muted-foreground">
                            {
                                NOVEL_MEDIA_TYPE[
                                    selectedRead.content
                                        .media_type as API.NovelMediaType
                                ].title_ua
                            }
                        </Label>
                    </>
        ...
        <>
            {list?.length === 0 && (
                <NotFound
                    ...
                    description="Додайте ранобе у список Читаю, щоб відстежувати їх прогрес"
                />
            )}
            {list && list.length > 0 && (
